...
class CommentSpider(scrapy.Spider):
    ...
    def parse(self, response):
        strings = "/search/category-fruits-and-vegetables/"
        strings2 = "/search/category-nuts-trail-mix/"
        strings3 = "/search/category-chips/"
        for href in  response.css('.c-navi-new-list__sublist-option--item a::attr(href)').extract():
            if (strings3 == href):
